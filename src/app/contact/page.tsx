      ...
      <section className="bg-[var(--color-cream-100)] pt-10 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl">
            <span className="badge badge-sage mb-5 inline-block">Запись</span>
            ...
            <p className="text-xl text-[var(--color-stone-500)] leading-relaxed">
              Заполните форму или напишите напрямую любым удобным способом.
              Я отвечаю в течение нескольких часов.
            </p>
          </div>
        </div>
      </section>
